      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Akari" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Creation Name</Label>
            <Input id="lastname" placeholder="DragonZ" type="text" />
          </LabelInputContainer>
        </div>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="password">Price (In BitCoin)</Label>
          <Input id="password" placeholder="--- Crypto" />
        </LabelInputContainer>
